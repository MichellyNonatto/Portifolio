...
export const CardViewComponent: React.FC<CardViewComponentProps> = ({
    ...
    return (
        <Paper
            elevation={5}
            className="p-12 min-w-80 max-w-96 rounded-lg shadow-lg"
            sx={{
            ...
            <div id="header">
                            ...
                            {Object.entries(header.listIconsURL).map(([url, icon]) => (
                                <a
                                    ...
                                    style={{
                                        ...
                                        width: `${header.title.size || 32}px`, // Mesmo tamanho do título
                                        height: `${header.title.size || 32}px`, // Mesmo tamanho do título
                                    }}
                                >
                                    {icon}
                                </a>
                ...
                {header.subtitle && (
                    <Typography
                        ...
                        sx={{ marginTop: `${header.subtitle.top || 16}px` }}
                    >
